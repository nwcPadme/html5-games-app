...
/**
 * @author Mad Games Maker <mad.games.maker@gmail.com>
 * @copyright Mad Games Maker 2019
 * @package html5_games_app
 * 
 * 
...
$config["dbase"] 		= "db_html5_games_app" ; 		//Database
...
$config["abs_url_images"] 		= "http://domain.com/apps/html5_games_app//media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "http://domain.com/apps/html5_games_app//media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "http://domain.com/apps/html5_games_app//media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "http://domain.com/apps/html5_games_app//media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	// TODO: -+- route
	case "route":		$rest_api=array();
		$rest_api["site"]["name"] = "HTML5 games app" ;
		$rest_api["site"]["description"] = "HTML5 games app" ;
